...
namespace CodeGeass.Characters.Api.Jobs
{
    /// <summary>
    ...
    public class IntegrationEventPublisherJob : IJob
    {
        ...
        public IntegrationEventPublisherJob(IBus bus, CodeGeassCharacterBdContext context, ILogger<IntegrationEventPublisherJob> logger)
        {
            _bus = bus;
            _context = context;
            _logger = logger;
